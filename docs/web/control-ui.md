...
Highlighting text in a chat message offers **More details**, which asks Side chat immediately, and **Ask in side chat**, which opens the rail with a quoted draft ready to edit.
